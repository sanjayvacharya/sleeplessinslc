...
public class ReviewApplicationInitializer implements WebApplicationInitializer {
  ...
  @Override public void onStartup(ServletContext ctx) throws ServletException {
    ...
    ctx.setInitParameter(ContextLoader.CONFIG_LOCATION_PARAM, ReviewJavaConfig.class.getName());
    ...
    servletRegistration.setInitParameter("javax.ws.rs.Application", ReviewApplication.class.getName());
  }
}
